...
# Run executable
$PROJECT_ROOT/webapp/build/packaged/quiz-flow-0.0.1.kexe
...
# Example of running automation test
./gradlew :api-automation-tests:testMain --tests "com.iv127.quizflow.api.automation.tests.SumTest"
```
